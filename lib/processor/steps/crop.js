...
module.exports = function(context, stepInfo) {
  ...
  if (context.saliency && context.originalImage.info.saliency && (stepInfo.anchor === 'auto' || (!stepInfo.anchor && context.saliency.options.autoCrop))) {
    const region = context.saliency.getSaliencyRegion(context.originalImage.info.saliency, {
