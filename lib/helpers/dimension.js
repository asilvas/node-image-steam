    ...
    if (info.unit === '%') {
      if (info.modifier === '+') {
        ...
        imageStep.width =
          ...
          parseInt(originalImage.info.width * (info.value / 100));
      } else {
        imageStep.width = parseInt(
    ...
    if (info.unit === '%') {
      if (info.modifier === '+') {
        ...
        imageStep.height =
          ...
          parseInt(originalImage.info.height * (info.value / 100));
      } else {
        imageStep.height = parseInt(
