  ...
  if (typeof imageStep.width === 'string') {
    ...
    if (info.unit === '%') {
      if (info.modifier === '+') {
        ...
        imageStep.width = originalImage.info.width - parseInt(originalImage.info.width * (info.value/100));
      } else {
  ...
  if (typeof imageStep.height === 'string') {
    ...
    if (info.unit === '%') {
      if (info.modifier === '+') {
        ...
        imageStep.height = originalImage.info.height - parseInt(originalImage.info.height * (info.value/100));
      } else {
