...
p.getHandler = function() {
  ...
  return function(req, res) {
    ...
    async.auto({
      getPrefetcher: async.timeout(function(cb) {
        // acquire prfetcher
        $this.throttle.getPrefetcher(req, cb);
      }, $this.options.stepTimeout),
      requestedImage: ['getPrefetcher', async.timeout(function(results, cb) {
      ...
      optimizedOriginalImage: ['requestedImage', async.timeout(function(results, cb) {
      ...
      originalImage: ['optimizedOriginalImage', async.timeout(function(results, cb) {
      ...
      hasProcessor: ['requestedImage', 'optimizedOriginalImage', 'originalImage', async.timeout(function hasProcessor(results, cb) {
      ...
      processedOptimizedImage: ['hasProcessor', 'optimizedOriginalImage', 'originalImage', async.timeout(function(results, cb) {
      ...
      processedImage: ['hasProcessor', 'processedOptimizedImage', 'originalImage', async.timeout(function(results, cb) {
        if (!results.hasProcessor) {
          return void cb();
        }
      ...
      storeProcessedImage: ['processedImage', async.timeout(function(results, cb) {
      ...
      storeOptimizedImage: ['processedOptimizedImage', async.timeout(function(results, cb) {
        // don't wait to respond
        cb();
