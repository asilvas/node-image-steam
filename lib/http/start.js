...
function startServer(config, httpConfig) {
  if (typeof httpConfig.globalAgent !== 'undefined') {
    http.globalAgent = _.isPlainObject(httpConfig.globalAgent) ? new Agent(httpConfig.globalAgent) : httpConfig.globalAgent;
    https.globalAgent = _.isPlainObject(httpConfig.globalAgent) ? new HttpsAgent(httpConfig.globalAgent) : httpConfig.globalAgent;
  }
