...
function startServer(config, httpConfig) {
  if (typeof httpConfig.globalAgent !== 'undefined') {
    http.globalAgent = typeof httpConfig.globalAgent === 'object' ? new Agent(httpConfig.globalAgent) : httpConfig.globalAgent;
    https.globalAgent = typeof httpConfig.globalAgent === 'object' ? new HttpsAgent(httpConfig.globalAgent) : httpConfig.globalAgent;
  }
