...
p.getInfo = function(req) {
  ...
  const useOriginal = this.options.useOriginal || routeInfo.urlInfo.query.useOriginal === 'true';
  ...
  const imageSteps = useOriginal ? [...routeInfo.imageSteps, { useOriginal }] : routeInfo.imageSteps;
