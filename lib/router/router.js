...
p.getInfo = function(req) {
  ...
  if (routeInfo.imageSteps.length === 0 && (this.options.noop || routeInfo.urlInfo.query.noop)) {
    var imageTypeIfUnknown;
    if (this.options.noop) imageTypeIfUnknown = this.options.noop.imageTypeIfUnknown;
