...
p.getInfo = function(req) {
  ...
  if (routeInfo.imageSteps.length === 0 && (this.options.useOriginal || routeInfo.urlInfo.query.useOriginal)) {
    var guessType;
    if (this.options.useOriginal) guessType = this.options.useOriginal.guessType;
    contentType = getImageContentType(req,routeInfo,guessType);
